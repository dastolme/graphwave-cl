...
CLOUD_RECO_PATH = "https://s3.cr.cnaf.infn.it:7480/cygno:cygno-analysis/RECO/Run4_Saladin/"
RECO_PATH       = "/raid/home/dastolfo/GraphWave-CL/Run4_LG/"
OUTPUT_H5       = f"{RECO_PATH}run4_lg_score_matrices.h5"

# Read logbook
ambe_logbook = cy.read_cygno_logbook(start_run=55174, end_run=56378)
run_list = (
    ambe_logbook
    .query("run_description == 'Standard, Low Gain'")
    ['run_number']
    .values
)
