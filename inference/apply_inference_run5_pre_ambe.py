...
OUTPUT_H5       = f"{RECO_PATH}pre_ambe_lg_score_matrices.h5"

# Read logbook
run5_logbook = cy.read_cygno_logbook(start_run=92000, end_run=96372)
run_list = (
    run5_logbook
    .query("run_description == 'Standard' and pedestal_run == 0")
    ['run_number']
    .values
)
